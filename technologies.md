...
- **Database**: MySQL 8.4+ / MySQL 9.0.1+ / MariaDB 10.11+ with Sequelize ORM
  - **Note**: MySQL 9.0.0 should be avoided (use 9.0.1+)
  - **Recommended**: MySQL 8.4 LTS (supported until April 2032) or MySQL 9.0.1+ for new features
...
- **i18n**: All user-facing messages should use i18n (req.\_\_()) for localization
