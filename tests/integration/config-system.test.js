...
describe('Configuration System Integration', () => {
  ...
  describe('Configuration Loading and Merging', () => {
    ...
    it('should handle missing or invalid config files gracefully', () => {
      ...
      fs.writeFileSync(path.join(tempDir, 'rest-spec.config.js'), 'invalid javascript syntax {');
  ...
  describe('Configuration Validation', () => {
    ...
    it('should detect configuration errors', () => {
      ...
      expect(errors.some(error => error.includes('Streaming threshold must be positive'))).toBe(
        true
      );
    });
  });
